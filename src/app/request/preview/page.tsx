...
function PreviewCard({ data }: { data: RequestData }) {
  ...
  return (
    <div style={{ background: "white", borderRadius: "20px", boxShadow: "0 4px 24px rgba(0,0,0,0.10)", overflow: "hidden", marginBottom: "24px", border: "1px solid #e8edf2" }}>
      <div style={{ background: "linear-gradient(135deg, #1a56db, #3b82f6)", padding: "16px 20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.18)", borderRadius: "100px", padding: "3px 12px", fontSize: "11px", fontWeight: 700, color: "white" }}>
          Goes live on publish
        </div>
      </div>
      <div style={{ padding: "20px" }}>
        ...
        <div style={{ display: "flex", gap: "12px" }}>
          <div style={{ flex: 1, background: "#fefce8", border: "1px solid #fef08a", borderRadius: "14px", padding: "14px 16px" }}>
            ...
            <div style={{ fontSize: "11px", color: "#a16207", marginTop: "5px" }}>Paid directly to your cleaner</div>
          </div>
          <div style={{ flex: 1, background: "#f0f5ff", border: "1px solid #c7d7f9", borderRadius: "14px", padding: "14px 16px" }}>
            ...
            <div style={{ fontSize: "11px", color: "#5272c4", marginTop: "5px" }}>Direct Debit · {pricing.sessionsPerMonth}</div>
          </div>
        </div>
...
export default function PreviewAndPublishPage() {
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const currentData = loadRequestData() ?? data
      await publishRequest({ ...currentData, finalNotes: finalNotes || undefined }, userId)
      clearRequestData()
      ...
      <div style={{ minHeight: "100vh", background: "linear-gradient(160deg, #f0f7ff 0%, #fefce8 50%, #f0fdf4 100%)", fontFamily: "'DM Sans', sans-serif", padding: "24px 16px 48px" }}>
        <div style={{ maxWidth: "520px", margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <p style={{ fontSize: "14px", color: "#64748b", margin: 0 }}>This is exactly what cleaners will see. Create your account to publish it.</p>
          </div>
          ...
          <div style={{ background: "rgba(255,255,255,0.85)", borderRadius: "28px", padding: "28px", border: "1.5px solid rgba(255,255,255,0.9)", boxShadow: "0 4px 32px rgba(59,130,246,0.08)" }}>
            <div style={{ textAlign: "center", marginBottom: "20px" }}>
              ...
              <div style={{ fontSize: "13px", color: "#64748b" }}>Create your free account to publish your request instantly</div>
            </div>
