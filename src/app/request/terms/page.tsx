...
const colorMap: Record<string, { bg: string; shadow: string }> = {
  blue: {
    ...
    shadow: "0 2px 10px rgba(59,130,246,0.15)",
  },
  yellow: {
    bg: "linear-gradient(135deg, #fefce8, #fef08a)",
    shadow: "0 2px 10px rgba(250,204,21,0.2)",
  },
  purple: {
  ...
  green: {
    ...
    shadow: "0 2px 10px rgba(34,197,94,0.15)",
  },
};
    ...
    <div style={{
      ...
      <div style={{ maxWidth: "600px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "32px" }}>
          ...
          <div style={{
            height: "4px", background: "#e2e8f0", borderRadius: "100px", overflow: "hidden", marginBottom: "8px",
          }}>
            <div style={{
              height: "100%", width: "75%",
        ...
        <div style={{ marginBottom: "32px" }}>
          ...
          <p style={{
            fontSize: "16px", color: "#64748b", lineHeight: 1.6, margin: 0,
          }}>
        ...
        <div style={{
          ...
          <label style={{ display: "flex", gap: "14px", alignItems: "flex-start", cursor: "pointer" }}>
            <div
              ...
              style={{
                ...
                marginTop: "1px",
                border: agreedGeneral ? "2px solid #3b82f6" : "2px solid #cbd5e1",
                background: agreedGeneral ? "linear-gradient(135deg, #3b82f6, #2563eb)" : "white",
                display: "flex", alignItems: "center", justifyContent: "center",
            ...
            <span style={{ fontSize: "14px", color: "#374151", lineHeight: 1.55 }}>
              ...
              <a href="/legal/terms" target="_blank" style={{ color: "#3b82f6", fontWeight: 600, textDecoration: "none" }}>
                Terms of Service
              </a>{" "}
              and{" "}
              <a href="/legal/privacy" target="_blank" style={{ color: "#3b82f6", fontWeight: 600, textDecoration: "none" }}>
                Privacy Policy
              </a>
            </span>
          </label>
          ...
          <label style={{ display: "flex", gap: "14px", alignItems: "flex-start", cursor: "pointer" }}>
            <div
              onClick={() => setAgreedPlatform(!agreedPlatform)}
              style={{
                width: "24px", height: "24px", borderRadius: "8px", flexShrink: 0,
                marginTop: "1px",
                border: agreedPlatform ? "2px solid #3b82f6" : "2px solid #cbd5e1",
                background: agreedPlatform ? "linear-gradient(135deg, #3b82f6, #2563eb)" : "white",
                display: "flex", alignItems: "center", justifyContent: "center",
                transition: "all 0.2s ease", cursor: "pointer",
              }}
            >
        ...
        <button
          ...
          onMouseEnter={e => {
            if (canProceed) (e.currentTarget as HTMLButtonElement).style.transform = "translateY(-2px)";
          }}
          onMouseLeave={e => {
        ...
        {!canProceed && (
          <p style={{
            textAlign: "center", fontSize: "13px", color: "#94a3b8", marginTop: "12px",
          }}>
