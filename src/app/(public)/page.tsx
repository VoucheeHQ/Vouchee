        ...
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-brand-100 px-4 py-1.5 text-sm font-medium text-brand-700">
              ...
              <span>Trusted local cleaners in Horsham</span>
            </div>
            ...
            <p className="mb-10 text-lg text-ink-secondary md:text-xl">
              Connect with vetted, local cleaners for weekly, fortnightly, or monthly services. 
        ...
        <div className="container">
          <div className="mx-auto mb-12 max-w-2xl text-center">
            ...
            <p className="text-lg text-ink-secondary">
              We make finding and managing your cleaner effortless
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card className="card-hover">
              <CardHeader>
                ...
                <CardDescription>
                  All cleaners are DBS checked, reference verified, and insured for your peace of mind
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="card-hover">
              <CardHeader>
                ...
                <CardDescription>
                  Choose weekly, fortnightly, or monthly cleans. Pause or adjust your schedule anytime
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="card-hover">
              <CardHeader>
                ...
                <CardDescription>
                  Simple platform to manage bookings, communicate, and report any issues
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="section bg-surface-secondary">
        <div className="container">
          ...
          <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-3">
            ...
            <Card className="border-brand-500 shadow-elevated">
              <CardHeader>
              ...
              <CardContent>
                ...
                <div className="mt-4 inline-block rounded-full bg-brand-100 px-3 py-1 text-xs font-medium text-brand-700">
                  Most popular
                </div>
              </CardContent>
            </Card>
