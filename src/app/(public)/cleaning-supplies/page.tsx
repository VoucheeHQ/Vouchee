...
const CATEGORIES = [
  { id: 'kitchen-bathroom', emoji: '🧴', name: 'Kitchen & Bathroom', description: 'The heavy hitters. Products our cleaners reach for every single session.', color: 'blue', count: 9 },
  { id: 'floors', emoji: '🧹', name: 'Floors', description: 'From hardwood to tile — keep every floor type looking its best.', color: 'green', count: 1 },
  { id: 'large-items', emoji: '🧳', name: 'Large Items & Equipment', description: 'The big kit. Hoovers, steam mops, carpet cleaners and more.', color: 'purple', count: 7 },
  { id: 'tools', emoji: '🪣', name: 'Tools & Accessories', description: 'The small things that make a huge difference. Scrubbers, cloths, gloves.', color: 'amber', count: 9 },
  { id: 'specialist', emoji: '⚗️', name: 'Specialist', description: 'For the tough jobs. Targeted products for specific problem areas.', color: 'red', count: 0, comingSoon: true },
  { id: 'eco', emoji: '🌿', name: 'Eco & Sensitive', description: 'Effective cleaning without harsh chemicals. Kind to skin, home, and planet.', color: 'teal', count: 0, comingSoon: true },
]
...
const PRODUCTS: Record<string, Product[]> = {
  'kitchen-bathroom': [
    ...
    },
    {
      ...
      url: 'https://amzn.to/4sS1OfP',
      img: BASE_IMG + '71JVOV7dQvL.jpg',
    },
    {
    ...
    {
      name: 'Cillit Bang Limescale Remover',
      description: 'Fast-acting spray for bathroom fixtures, taps, and shower trays.',
      why: 'Good for everyday maintenance when Viakal is overkill.',
      url: 'https://amzn.to/41GXZxY',
      img: BASE_IMG + '71lnEkoRyxL.jpg',
    },
  ],
  'floors': [
    {
  ...
  'large-items': [
    ...
    {
      name: 'Flat Mop and Bucket',
      description: 'Flat mop with wringer bucket — the professional\'s choice for hard floors.',
      why: 'Microfibre flat mops cover more ground and pick up more dirt than string mops.',
      url: 'https://amzn.to/4m9sGp3',
      img: BASE_IMG + '81pyye40tnL.jpg',
    },
    {
    ...
    },
    {
      ...
      description: 'Multi-compartment tote bag for carrying cleaning supplies between jobs.',
      why: 'Keeps products organised and prevents leaks in transit.',
  ...
  'tools': [
    ...
    },
    {
      ...
      why: 'Gets into spots that are impossible to reach with a cloth.',
      url: 'https://amzn.to/4dnK1Ix',
      img: BASE_IMG + '616OoA4nOOL.jpg',
    },
    {
...
// Starter kit bundle — pre-populated Amazon basket
            ...
            <div className="container max-w-5xl mx-auto px-6 py-14">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {products.map((product, i) => (
                  <div key={i} className="rounded-xl border border-gray-200 bg-white overflow-hidden hover:shadow-md transition-shadow flex flex-col">
                    {/* Product image */}
                    <a href={product.url} target="_blank" rel="noopener noreferrer sponsored" className="block bg-gray-50 p-4 flex items-center justify-center h-48">
                      <img
                        src={product.img}
                        alt={product.name}
                    ...
                    <div className="p-5 flex flex-col flex-1">
                      <div className="flex items-start justify-between gap-3 mb-2">
                        <h3 className="font-bold text-gray-900 text-sm leading-tight font-sans">{product.name}</h3>
                        {product.tag && (
