...
export const metadata: Metadata = {
  ...
  description: 'Practical cleaning advice, guides for finding the right cleaner, and tips for self-employed cleaners — written by the Vouchee team and our professional cleaners.',
