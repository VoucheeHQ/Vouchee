...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/legal/terms/customer' },
}
      ...
      <section className="container max-w-3xl mx-auto px-6 py-16">
        <div className="prose prose-gray max-w-none">
          ...
          <Section id="11" title="11. Subscriptions and Payments">
            ...
            <p>Subscriptions operate on a 30-day rolling basis. To cancel, you must give 30 days' written notice through the platform. You will continue to have full access to the platform, and your Cleaner will continue to perform cleans, during this notice period.</p>
            <p>Where the 30-day notice period ends part-way through a billed month, Vouchee will refund the unused portion of that month's subscription fee on a pro-rata basis. The refund is calculated as (days from notice end to end of the billed period / total days in the billed period) × monthly fee, and is issued via GoCardless within 14 days of the notice period ending.</p>
