            ...
            <div className="ep-steps">
              <div className="ep-step">
                ...
                <div>
                  ...
                  <div className="ep-step-body">Tell us how many hours you'd like to fill and which areas in Horsham you're happy to cover.</div>
                </div>
              </div>
              <div className="ep-step">
                <div className="ep-step-num">2</div>
                <div>
                  <div className="ep-step-title">Browse local requests</div>
                  <div className="ep-step-body">Upon launch, you'll see cleaning requests from customers in Horsham. Every listing shows their local area, preferred days and time, how many hours and how often.</div>
                </div>
              </div>
              <div className="ep-step">
                <div className="ep-step-num">3</div>
                <div>
                  <div className="ep-step-title">Choose the jobs you want</div>
                  <div className="ep-step-body">You're in control. Apply only for the work you want, set your own rate, and agree everything directly with the customer.</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="ep-section">
          ...
          <div className="ep-props">
            ...
            <div className="ep-prop">
              <div className="ep-prop-icon">💷</div>
              <div>
                <div className="ep-prop-title">Your rate</div>
                <div className="ep-prop-body">You're free to discuss your rate with the customer knowing that Vouchee doesn't take a cut of your hourly earnings.</div>
              </div>
            </div>
            <div className="ep-prop">
              <div className="ep-prop-icon">📅</div>
              <div>
                <div className="ep-prop-title">Fits around your schedule</div>
                <div className="ep-prop-body">You're in control of when you work and how many new clients you take on at any one time. If you need to adjust further down the line, just speak to the customer.</div>
              </div>
            </div>
            <div className="ep-prop">
              <div className="ep-prop-icon">⭐</div>
              <div>
                <div className="ep-prop-title">Build on your current reputation</div>
                <div className="ep-prop-body">Every job completed through Vouchee adds a verified review to your profile, helping you get more customers.</div>
              </div>
            </div>
          </div>
        </div>
          ...
          {submitted ? (
            ...
            <div className="ep-card">
              <div className="ep-form">
                ...
                <div>
                  <label className="ep-label">How many clients do you currently have?</label>
                  <select className="ep-select" value={form.currentClients} onChange={e => setForm(f => ({ ...f, currentClients: e.target.value }))}>
                    <option value="">Select...</option>
                    <option value="1-3">1–3 clients</option>
                    <option value="4-8">4–8 clients</option>
                ...
                <p style={{ fontSize: '12px', color: '#94a3b8', textAlign: 'center', lineHeight: 1.5 }}>
                  No commitment. We'll be in touch before launch. Your existing clients are never affected.
                </p>
