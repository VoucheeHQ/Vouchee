        ...
        <div className="ep-section">
          ...
          {submitted ? (
            <div className="ep-card ep-success">
              ...
              <div className="ep-success-body">We'll be in touch before launch with everything you need to get started. Your first month is completely free.</div>
            </div>
          ) : (
            <div className="ep-card">
              <div className="ep-form">
                ...
                <div>
                  <label className="ep-label">How do you currently find your clients?</label>
                  <select className="ep-select" value={form.howTheyFindClients} onChange={e => setForm(f => ({ ...f, howTheyFindClients: e.target.value }))}>
                    <option value="">Select...</option>
                    <option value="word-of-mouth">Word of mouth / recommendations</option>
                    <option value="flyers">Flyers or local ads</option>
                    <option value="facebook">Facebook groups</option>
                    <option value="other">Other</option>
                    <option value="not-yet">I haven't started yet</option>
                  </select>
                </div>
                <div>
